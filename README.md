...
below 55 °C between runs, **iGPU at 2400 MHz** — since 2026-09-11 it runs at its stock 2000 MHz,
so a re-run will show prefill roughly 17 % lower for that reason alone. Prefill = prompt processing, TG = token generation at that KV
